...
#       Positional embedding
    ...
    def forward(self, x):
        ...
        if self.hybrid == False:
            ...
            x = DDFA.generate_uv_tex(x, self.xception_feature_extractor, self.sequence_embedding, self.linear_1, self.proj, self.seq_embed, self.hybrid, self.variant, self.device)
